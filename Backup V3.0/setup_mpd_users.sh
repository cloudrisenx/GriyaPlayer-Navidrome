...
echo "Memulai Auto-Provisioning 11 Zona MPD Griya Persada..."
...
# --- BACKGROUND DOWNLOAD CACHE (FILE RAW) ---
input_cache {
    size "16 MB"
}
...
# --- OPTIMASI KONEKSI NAVIDROME (MENCEGAH SKIP LAGU PANJANG) ---
input {
    plugin "curl"
    timeout "120"
}
...
echo "BERHASIL! Semua 11 zona MPD sudah online dan berjalan di background."
